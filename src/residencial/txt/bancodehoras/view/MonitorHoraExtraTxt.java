...
public class MonitorHoraExtraTxt extends JDialog {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Cadastrar Hora Extra");
    ...
    private javax.swing.JComboBox<String> cbMonitoras;
    ...
    public void preecheTabelaHoras(){
        int horaExtra = 0,
            minutoExtra = 0,
            horaCredito = 0,
            minutoCredito = 0,
        ...
        for(String m : lista) {
            ...
            //PEGA O NOME DA MONITORA E COMPARA SE É IGUAL AO DA LISTA. SE FOR ADICIONA NA TABLE
            if(cbMonitoras.getSelectedItem().equals(dados[1])){
    ...
    public void calculaHoraExtra(String h, String m){
